...
public class GoogleDriveTest {
    ...
    public void test() throws Exception {
        ...
        GoogleCredential credential = new GoogleCredential.Builder().setTransport(httpTransport)
            ...
            .setServiceAccountPrivateKeyFromP12File(new java.io.File("/Users/mvdb/mvdbinfra-62243e827a4a.p12"))
        ...
        fileMetadata.setTitle("apenootjes.txt");
        ByteArrayContent content = new ByteArrayContent("plain/text", "Dit is een test van martin".getBytes());
        File result = drive.files().insert(fileMetadata, content).execute();
//        Changes changes = drive.changes();
//        System.out.println(changes.list().execute());
//        System.out.println(drive.changes());
    }
}
